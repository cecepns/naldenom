...
import { Building, Users, Award, Target, MapPin, Calendar, User } from 'lucide-react';
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">About NALDENOM EXPORT IMPORT</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A national private company engaged in export-import business with a commitment to providing the best service
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-blue-600 text-white p-6 rounded-xl shadow-xl">
              <div className="text-center">
                <div className="text-3xl font-bold">{company.established_year || '2025'}</div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              {company.description || 'NALDENOM EXPORT IMPORT is a company established in 2025 with a vision to become a trusted partner in international trade. We are committed to connecting Indonesia with the global market through professional and quality export-import services.'}
            </p>
            <p className="text-gray-600 leading-relaxed">
              With a strategic location in South Solok Regency, West Sumatra, we serve various trading needs 
              from automotive spare parts, forestry products, food ingredients, to textile products and accessories.
            </p>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{company.director || 'WARNERI PUTERA SH.M.Kn.'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{company.location || 'Solok Selatan, Sumatera Barat'}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
            ...
            <p className="text-2xl font-bold text-blue-600">{company.established_year || '2025'}</p>
          </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Business Activities</h3>
